"""Tests all function in src.pfalgorithms_richelbilderbeek.easy_questions."""
import unittest

from src.pfalgorithms_richelbilderbeek.easy_questions import (
    is_zero,
)
...
class TestEasySolutions(unittest.TestCase):
    ...
    """Class to test the functions in src.pfalgorithms_richelbilderbeek.easy_questions."""
